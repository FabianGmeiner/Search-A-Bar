...
public class Bar {
    ...
    public String getmAdress(){return mAdress;}
    ...
    public void setAdress(String adress) {mAdress = adress;}
    public void setCategory(int category) {mCategory = category;}
    public void setGpsLongitude(double gpsLongitude) {mGpsLongitude = gpsLongitude;}
    public void setGpsLatitude(double gpsLatitude) {mGpsLatitude = gpsLatitude;}
    public void setPrice(double price) {mPrice = price;}
    public void setAgeRestriction(int ageRestriction) {mAgeRestriction = ageRestriction;}
    public void setAverageAge(int averageAge) {mAverageAge = averageAge;}
    public void increasePopularity(){mPopularity++;}
